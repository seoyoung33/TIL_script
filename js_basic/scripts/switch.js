...
switch(order){
    case '딸기':alert('딸기는 1,000원입니다.');
    break;
    case '수박':alert('수박은 10,000원입니다.');
    break;
    case '오렌지':alert('오렌지는 5,000원입니다.');
    break;
    case '망고':alert('망고는 7,000원입니다.');
    break;
...
switch(callNumber){
    case '1' :alert('엄무이'); break;
    case '2' :alert('아부디'); break;
    case '3' :alert('마이부라더'); break;
